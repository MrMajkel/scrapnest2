...
<head>
  ...
  <title>ScrapNest - Kontrahenci</title>
  <link rel="stylesheet" href="css/common2.css">
  <link rel="stylesheet" href="css/common.css">
  <link rel="stylesheet" href="css/modal.css" />
  <link rel="stylesheet" href="css/modal_add_contractors.css" />
...
<body>
  ...
  <main class="content">
    <section class="section">
      <div class="section-header">
        <h2>Kontrahenci</h2>
        <button class="add-button">+ Dodaj kontrahenta</button>
      </div>
      <table>
        <thead>
          <tr>
        ...
        <tbody>
          <tr><td colspan="7">Ładowanie danych...</td></tr>
        </tbody>
      </table>
  ...
  <div id="confirmModal" class="modal hidden">
    <div class="modal-content">
      <p>Na pewno usunąć kontrahenta?</p>
